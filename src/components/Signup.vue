  ...
  <div class="col-sm-4 col-sm-offset-4">
    ...
    <form @submit.prevent="register()" onsubmit="return passwordAccept()">
      ...
      <div id="text" style="display:none"><p style="color:#656565">
        (We will not spam your email, this is strictly for contact between users)</p></div>
      <div class="md-form">
      ...
      <div id="text2" style="display:none"><p style="color:#656565">
        (Must be between 8-16 characters and contain one number and special character !@#$%^&*)</p></div>
      <div class="md-form">
